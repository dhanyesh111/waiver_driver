    ...
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
                ...
                children: [
                  GetX<DrivingLicenceController>(builder: (controller) {
                    return UpLoadImageTemplate(
                        ...
                        isRectangle: true,
                        image: controller.drivingLicenceFrontSide.value,
                  ...
                  GetX<DrivingLicenceController>(builder: (controller) {
                    return UpLoadImageTemplate(
                        ...
                        image: controller.drivingLicenceBackSide.value,
                        onTap: (ImageSource source) => controller.uploadPhoto(
              ...
              return controller.showErrorMessageDrivingLicence.value
                  ? Column(
                      ...
                      children: [
                        ...
                        Text(
                          controller.errorMessageDrivingLicence.value,
            ...
            BlueButton(
              text: "Upload",
              onTap: () => DrivingLicenceController.to.uploadDocument(),
              icon: CircleWithIcon(
                height: 25.sp,
